...
set_input_delay 5.0000 -clock [get_clocks {prog_clk}] -add_delay [get_ports {top_width_0_height_0_subtile_1__pin_outpad_0_}]
set_input_delay 5.0000 -clock [get_clocks {prog_clk}] -add_delay [get_ports {top_width_0_height_0_subtile_2__pin_outpad_0_}]
set_input_delay 5.0000 -clock [get_clocks {prog_clk}] -add_delay [get_ports {top_width_0_height_0_subtile_3__pin_outpad_0_}]
...
set_output_delay 5.0000 -clock [get_clocks {prog_clk}] -add_delay [get_ports {top_width_0_height_0_subtile_1__pin_inpad_0_}]
set_output_delay 5.0000 -clock [get_clocks {prog_clk}] -add_delay [get_ports {top_width_0_height_0_subtile_2__pin_inpad_0_}]
set_output_delay 5.0000 -clock [get_clocks {prog_clk}] -add_delay [get_ports {top_width_0_height_0_subtile_3__pin_inpad_0_}]
###############################################################################
# Environment
###############################################################################
set_load -pin_load 0.0729 [get_ports {ccff_tail}]
set_load -pin_load 0.0729 [get_ports {top_width_0_height_0_subtile_0__pin_inpad_0_}]
set_load -pin_load 0.0729 [get_ports {top_width_0_height_0_subtile_1__pin_inpad_0_}]
set_load -pin_load 0.0729 [get_ports {top_width_0_height_0_subtile_2__pin_inpad_0_}]
set_load -pin_load 0.0729 [get_ports {top_width_0_height_0_subtile_3__pin_inpad_0_}]
...
set_driving_cell -lib_cell gf180mcu_fd_sc_mcu7t5v0__inv_1 -pin {ZN} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {top_width_0_height_0_subtile_0__pin_outpad_0_}]
set_driving_cell -lib_cell gf180mcu_fd_sc_mcu7t5v0__inv_1 -pin {ZN} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {top_width_0_height_0_subtile_1__pin_outpad_0_}]
set_driving_cell -lib_cell gf180mcu_fd_sc_mcu7t5v0__inv_1 -pin {ZN} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {top_width_0_height_0_subtile_2__pin_outpad_0_}]
set_driving_cell -lib_cell gf180mcu_fd_sc_mcu7t5v0__inv_1 -pin {ZN} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {top_width_0_height_0_subtile_3__pin_outpad_0_}]
